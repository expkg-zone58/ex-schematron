...
<!-- 
     OVERVIEW - lnuk_abstract_expand_modified.xsl
...
<!-- 
  VERSION INFORMATION
  2015-05-14 Sheila Thomson
  		* Fixing bug #6 (https://code.google.com/p/schematron/issues/detail?id=6) with solution proposed here:  
...
<xslt:stylesheet version="1.0" xmlns:xslt="http://www.w3.org/1999/XSL/Transform" 
	...
	<xslt:template mode="iae:do-pattern" match="*">
		<xslt:param name="caller"/>
		<xslt:copy>
			<xslt:for-each select="@*[name()='test' or name()='context' or name()='select' or name()='value']">
			...
			<xslt:copy-of select="@*[name()!='test'][name()!='context'][name()!='select'][name()!='value']" />
